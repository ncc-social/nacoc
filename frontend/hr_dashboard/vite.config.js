...
export default defineConfig({
    ...
    define: {
        ...
        '__ROUTER_BASE__': JSON.stringify('/ex-dashboard')
    },
    ...
    plugins: [
        {
            ...
            closeBundle() {
                ...
                // Destination: apps/nacoc/nacoc/www/ex-dashboard/index.html
                const destDir = path.resolve(__dirname, '../../nacoc/www/ex-dashboard');
