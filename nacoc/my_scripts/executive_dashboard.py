    ...
    if search:
        ...
        filters.append(
            ...
            " OR ".join([
                ...
                f"e.employee_number LIKE {frappe.db.escape(search)}",
...
def get_leave_report(year=None, department=None):
    ...
    for emp in employees:
        ...
        emp_data["leave_arrears"] = int(leave_arrears)
        emp_data["total_leaves_allocated"] = int(total_allocated)
        emp_data["leave_due"] = int(leave_due)
        ...
        leave_apps = frappe.get_all("Leave Application",
            filters={
                "employee": emp.name,
                "docstatus": 1,
                "leave_type": ["in", ["Annual Leave - JD", "Annual Leave - SD"]],
                "workflow_state": "Leave APPROVED"
            },
        ...
        emp_data["outstanding_leave"] = int(total_allocated - total_taken)
